...
Observamos a possibilidade de um efeito sazonal nas vendas da Zoop Megastore e buscamos confirmar essa hipótese através da modificação do 
gráfico. A comparação entre os anos é nossa próxima etapa, retomando à consulta no SQLite Online.*/
...
/* Progredimos consideravelmente em nossa análise para o relatório, conduzindo diversos estudos sobre os dados dos fornecedores durante a 
Black Friday e as categorias. Contudo, um requisito essencial na demanda refere-se a uma métrica.

A intenção é conceder autonomia ao time de negócios para que possam monitorar o impacto de suas ações na Black Friday deste ano. Eles têm a 
opção de requisitar um dashboard ou um relatório de acompanhamento de vendas, mas nada supera a autonomia que adquirem ao não dependerem 
de outra equipe. */
...
-- Agora, como pegaremos essas duas subconsultas, as combinaremos e faremos o cálculo de porcentagem? 
-- Queremos saber o quão superior ou inferior à média das Black Fridays anteriores está a Black Friday atual.
